...
readonly VERSION="nightly-2023-05-26"
readonly FLAGS_BUGGY="-Zmir-opt-level=1 -Copt-level=3"
readonly FLAGS_CORRECT1="-Zmir-opt-level=2 -Copt-level=3"
readonly FLAGS_CORRECT2="-Zmir-opt-level=3 -Copt-level=3"
